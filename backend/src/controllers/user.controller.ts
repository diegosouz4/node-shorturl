...
class UserController {
  async create(req: Request, res: Response) {
    ...
    try {
      ...
      return successResponse({ res, message: 'New freebie user created!', statusCode: HTTP_STATUS.CREATED, data: user });
    } catch (err) {
  ...
  async list(req: Request, res: Response) {
    ...
    try {
      ...
      return successResponse({ res, message: 'Users listed successfully', statusCode: HTTP_STATUS.OK, data: users });
    } catch (err) {
      const { message, statusCode } = handleErrorDetails(err);
      log.error({ err, reqUser: jwtUser, pagination }, message);
      return errorResponse({ res, message: 'Error listing users', statusCode: statusCode ?? HTTP_STATUS.INTERNAL_SERVER_ERROR, details: message });
    }
  }
  ...
  async find(req: Request, res: Response) {
    ...
    try {
      ...
      return successResponse({ res, message: 'User found successfully', statusCode: HTTP_STATUS.OK, data: user });
    } catch (err) {
      const { message, statusCode } = handleErrorDetails(err);
      log.error({ err, reqUser: jwtUser, targetId: req.params.id }, message);
      return errorResponse({ res, message: 'Error finding user', statusCode: statusCode ?? HTTP_STATUS.INTERNAL_SERVER_ERROR, details: message });
    }
  }
  ...
  async update(req: Request, res: Response) {
    ...
    try {
      ...
      return successResponse({ res, message: 'User updated successfully', statusCode: HTTP_STATUS.OK });
    } catch (err) {
      const { message, statusCode } = handleErrorDetails(err);
      const payload = req.body as updateUserTypes;
      log.error({ err, reqUser: jwtUser, payload }, message);
      return errorResponse({ res, message: 'Error updating user', statusCode: statusCode ?? HTTP_STATUS.INTERNAL_SERVER_ERROR, details: message });
    }
  }
  ...
  async reactivate(req: Request, res: Response) {
    ...
    try {
      ...
      return successResponse({ res, message: "User reactivated successfully", statusCode: HTTP_STATUS.OK });
    } catch (err: unknown) {
      const { message, statusCode } = handleErrorDetails(err);
      log.error({ err, reqUser: jwtUser, targetId: req.params.id }, message);
      return errorResponse({ res, message: "Error reactivating user", statusCode: statusCode ?? HTTP_STATUS.INTERNAL_SERVER_ERROR, details: message });
    }
  }
  ...
  async delete(req: Request, res: Response) {
    ...
    try {
      ...
      return successResponse({ res, message: 'User deleted successfully', statusCode: HTTP_STATUS.OK });
    } catch (err) {
      const { message, statusCode } = handleErrorDetails(err);
      log.error({ err, reqUser: jwtUser, targetId: req.params.id }, message);
      return errorResponse({ res, message: 'Error deleting user', statusCode: statusCode ?? HTTP_STATUS.INTERNAL_SERVER_ERROR, details: message });
    }
  }
}
